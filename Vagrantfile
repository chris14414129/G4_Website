...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "csy2028-v3" do |csy2028|
  end

  # Give the box a name to make it easily identifiable inside virtualbox
  config.vm.provider :virtualbox do |vb|
      vb.name = "csy2028-vagrant-v3"
  end
  config.vm.box = "csy2028-v3"
  ...
  config.vm.box_url = ["file:///V:/CSY2028/csy2028-v3.box", "http://www.eng.nene.ac.uk/~tom/csy2028/csy2028-v3.box"]
